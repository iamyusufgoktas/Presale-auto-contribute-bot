...
console.log('Welcome to Auto contribute bot!');
...
var logsPath = logsDir + 'Auto contribute-bot-' + new Date().toISOString().slice(0,10) + '.txt';
...
async function initBotLogic() {
    ...
    if (botInitialDelay > 0) {
        console.log('Starting the Auto contribute bot in ' + (botInitialDelay / 1000) + ' seconds... ¯\\_(*o*)_/¯');
    } else {
        console.log('Starting the Auto contribute bot now... ¯\\_(*o*)_/¯');
    }
